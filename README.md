...
- このモックでは、ルートの `index.html` / `styles.css` / `script.js` で README / AGENTS.md の内容を確認するための静的サイトを提供しています。
- ブラウザ確認時は、たとえば `python3 -m http.server 8000` を実行して `http://localhost:8000` を開いてください。
